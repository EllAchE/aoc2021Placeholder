...
# print baseline
maxManhattan = 0
for s, scanner1 in enumerate(scannerCoordinates):
    for scanner2 in scannerCoordinates[s:]:
        manhattan = abs(scanner1[0]-scanner2[0]) + abs(scanner1[1]-scanner2[1]) + abs(scanner1[2]-scanner2[2])
        if maxManhattan < manhattan:
